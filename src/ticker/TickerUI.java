...
public class TickerUI extends JComponent {
  ...
  private void buildImage(String text) {
    ...
    image = new BufferedImage(textWidth + horizontalPad, textHeight + verticalPad,
        BufferedImage.TYPE_INT_RGB);
  ...
  private void runWork() {
    while (noStopRequested) {
      try {
        Thread.sleep(10); // 1 frame per second
  ...
  public static void main(String[] args) throws IOException {
    TickerUI st = new TickerUI(Ticker.ticker());
